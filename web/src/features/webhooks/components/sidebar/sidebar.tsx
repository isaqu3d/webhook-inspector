...
import { WebhooksList } from "../webhook-list/webhooks-list";
import { WebhooksListItemSkeleton } from "../webhook-list/webhooks-list-item-skeleton";
    ...
    <div className="flex h-screen flex-col">
      <div className=" flex items-center justify-between border-b border-zinc-700 px-4 py-5">
        <div className="flex items-baseline">
          <h1 className="font-semibold text-zinc-100">webhook</h1>
      ...
      <Suspense fallback={<WebhooksListItemSkeleton />}>
        <WebhooksList />
      </Suspense>
    </div>
  );
